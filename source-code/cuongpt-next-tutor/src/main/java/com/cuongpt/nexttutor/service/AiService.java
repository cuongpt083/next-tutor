...
public class AiService {
     ...
     *
     * @param context the context for quiz generation
     * @return JSON string representing the list of questions
     */
    public String generateQuiz(String context) {
        // Mock response
        return "[{\"id\": \"q1\", \"type\": \"MULTIPLE_CHOICE\", \"content\": \"Sample Question generated by AI\", \"options\": [\"Option A\", \"Option B\", \"Option C\", \"Option D\"], \"solution\": \"Option A\", \"explanation\": \"Because it is correct.\", \"hint\": \"Think about A.\"}]";
    }
}
